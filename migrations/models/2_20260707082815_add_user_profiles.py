...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        CREATE TABLE IF NOT EXISTS "llm"."user_profiles" (
    "id" BIGSERIAL NOT NULL PRIMARY KEY,
    "created_at" TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "user_id" BIGINT NOT NULL UNIQUE,
    "username" TEXT,
    "engagement_score" INT NOT NULL DEFAULT 0,
    "replies_to_them" INT NOT NULL DEFAULT 0,
    "successes" INT NOT NULL DEFAULT 0,
    "last_seen" TIMESTAMPTZ
);
CREATE INDEX IF NOT EXISTS "idx_user_profil_user_id_7bc1bb" ON "llm"."user_profiles" ("user_id");"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        DROP TABLE IF EXISTS "llm"."user_profiles";"""
