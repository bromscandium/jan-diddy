...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ALTER TABLE "llm"."successful_dialogs" ADD COLUMN IF NOT EXISTS "embedding" vector(1024);
        CREATE INDEX IF NOT EXISTS "sd_embedding_idx" ON "llm"."successful_dialogs" USING hnsw ("embedding" vector_cosine_ops);"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        DROP INDEX IF EXISTS "llm"."sd_embedding_idx";
        ALTER TABLE "llm"."successful_dialogs" DROP COLUMN IF EXISTS "embedding";"""
